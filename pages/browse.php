...
<html>
  ...
  <body>
      <div id="all">
          ...
          require_once '../configs/readingconf.php';
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm category-menu">
                    <li class="nav-item"><a href="shop-category.html" class="nav-link d-flex align-items-center justify-content-between"><span>All</span><span class="badge badge-secondary">
                                <?php 
                      ...
                      <ul class="nav nav-pills flex-column">
                        <li class="nav-item"><a href="shop-category.html" class="nav-link">Home Appliances
                        ...
                        <li class="nav-item"><a href="shop-category.html" class="nav-link">Furniture
                            <span class="badge badge-secondary">
                                    <?php 
                        ...
                        <li class="nav-item"><a href="shop-category.html" class="nav-link">Computers and IT
                            <span class="badge badge-secondary">
                                    <?php 
                        ...
                        <li class="nav-item"><a href="shop-category.html" class="nav-link">Kids
                            <span class="badge badge-secondary">
                                    <?php 
                        ...
                        <li class="nav-item"><a href="shop-category.html" class="nav-link">Home Repairs & Services
                            <span class="badge badge-secondary">
                                    <?php 
