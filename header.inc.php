...
<header class="nav-holder make-sticky">
   <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
      <div class="container">
         <a href="index.html" class="navbar-brand home"><img src="img/logo.png" alt="Fastrade logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Fasttrade logo" class="d-inline-block d-md-none"><span class="sr-only">FastTrade</span></a>
